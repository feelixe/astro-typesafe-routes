...
const config: Config = {
  ...
  organizationName: "feelixe",
  projectName: "astro-typesafe-routes",
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: "https://github.com/feelixe/astro-typesafe-routes",
          label: "GitHub",
          position: "right",
        },
      ],
    ...
    footer: {
      style: "dark",
      copyright: `Copyright © ${new Date().getFullYear()} Astro Typesafe Routes, Inc. Built with Docusaurus.`,
    },
    prism: {
