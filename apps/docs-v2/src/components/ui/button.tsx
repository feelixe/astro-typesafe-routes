...
export type LinkButtonProps<T extends RouteId> = ComponentProps<typeof Button> & RouteOptions<T>;

export function LinkButton<T extends RouteId>(props: LinkButtonProps<T>) {
